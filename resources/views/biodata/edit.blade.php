    ...
    <div class="container">
        <form action="{{ route('biodata.update', $bio->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input value="{{ $bio->nama }}" type="text" name="nama" id="" class="form-control" placeholder="Nama Lengkap" aria-describedby="helpId">
            </div>
            <div class="form-group">
              <label for="">Alamat</label>
              <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control">{{ $bio->alamat }}</textarea>
            </div>
            <div class="form-group">
              <label for="">Tanggal lahir</label>
              <input value="{{ $bio->tanggal_lahir }}" type="date" name="tanggal_lahir" id="" class="form-control" placeholder="Tanggal Lahir" aria-describedby="helpId">
            </div>
            <div class="form-group">
